...
Identifying important transcription factor (TF) motifs, as shown in `r Biocpkg("monaLisa", vignette="monaLisa.html", label="the main vignette")`,
...
`stabs::glmnet.lasso` function used by `stabs::stabsel` from the `r CRANpkg("stabs")`
package to implement the randomized lasso.
...
(see the `r Biocpkg("monaLisa", vignette="monaLisa.html", label="binned enrichment vignette")`).
