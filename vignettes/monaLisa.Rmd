...
tmp <- tempfile()
convert <- dumpJaspar(filename = tmp, pkg = "JASPAR2018", 
...
# - notice the absence of zero values, caused by a pseudocount
#   of 1.0 added to each element of the PFM by `dumpJaspar`
as.matrix(pfms[[1]])
