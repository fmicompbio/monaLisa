...
of the `"enr"` assay. As many transcription factor binding motifs are similar to
...
parallelize it using the `BPARAM` argument (e.g. to run on `n` parallel threads
...
in the heatmap. The plotting of the dendogram is controlled by the parameter
