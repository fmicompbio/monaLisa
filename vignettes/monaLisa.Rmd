...
Generally speaking, the number of sequences per bin should not be below ~100 (which is the case here) as fewer sequences will lead to small motif counts and thus either small or unstable enrichments. 
