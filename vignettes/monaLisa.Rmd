...
SimMat <- motifSimilarity(rowData(se)$motif.pfm, BPPARAM = BiocParallel::MulticoreParam(20))
```

<!--
saveRDS(SimMat, "/tungstenfs/groups/gbioinfo/stadler/development/R/monaLisa/inst/extdata/SimMat.rds")
-->
