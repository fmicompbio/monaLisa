...
- In **binned motif enrichment analysis** (`calcBinnedMotifEnrR`, see section
...
against background sequences) or to determine motif enrichments in a single set
of sequences compared to a suitably matched genomic background set. The binned
motif enrichment approach was first introduced in
