...
approach was first introduced in @ginno2018 and subsequently applied in e.g.
@barisic2019. To see more details on how `calcBinnedMotifEnrR` resembles
...
motifs. For a quick description of motif representations see section
\@ref(motifConvert). Here is an example (just on a few sequences/motifs for
illustration):
